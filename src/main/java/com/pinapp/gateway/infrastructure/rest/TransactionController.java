...
public class TransactionController {
    ...
    @PostMapping("/batch")
    public ResponseEntity<List<String>> processBatch(
            @RequestBody(description = "Lista de transacciones a procesar") @org.springframework.web.bind.annotation.RequestBody List<TransactionRequest> requests) {
    ...
    public ResponseEntity<TransactionStatusDTO> getStatus(
        ...
        return statusStore.getStatus(id)
